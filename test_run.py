...
with open('results.csv', 'w', newline='') as csvfile:
    ...
    total_tests = len(test_types) * len(read_write_ratios) * (14 + 14)
    test_count = 0
    ...
    for test_type in test_types:
        for r in read_write_ratios:
            ...
            for n in range(0, 14):
                ...
                writer.writerow({'test_type': test_type, 'r': r, 'n': 2**n, 'o': 32, 'average': average})
                test_count += 1
            ...
            for o in range(0, 14):
                ...
                writer.writerow({'test_type': test_type, 'r': r, 'n': 32, 'o': 2**o, 'average': average})
                test_count += 1
                print(f'Progress: {test_count}/{total_tests} ({(test_count/total_tests)*100:.2f}%)')
